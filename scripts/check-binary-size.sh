...
# (Budget history: 25 -> 30 MiB once webrtc-rs landed; 30 -> 32 MiB once the
# tracing/tracing-subscriber/time observability stack landed for daemon logging.
# ~29 MiB is the floor for a wry+webrtc desktop app.)
#
